...
/*<a href="javascript:bookmark()" title="����ҳ�����ղ�" target="_self">�����ղ�</a>*/
...
$(function(){
	...
	var tab_jb_nav_li = $('.tab_jb_nav li');//�л���ʽ
	...
	var tab_jg_nav_li = $('.jgdwboxtit li');//�л���ʽ
	...
	var tab_reg_nav_li = $('.registerboxnrltit li');//�л���ʽ
	...
	var tab_rpd_nav_li = $('.rtpawdtit li');//�л���ʽ
	...
	var tab_qus_nav_li = $('.quesnav li');//�л���ʽ
	...
	$('.quesall .quescon').eq(tab_qus_nav_li_index).show()
		...
		var tab_ss_nav_li = $('.sstab li');//�л���ʽ
	...
	$('.ssquesall .ssquesbox').eq(tab_ss_nav_li_index).show()
		...
		var tab_zh_nav_li = $('.sstab li');//�л���ʽ
	...
	var tab_yyjs_nav_li = $('.yyjs_sstab li');//�л���ʽ
