...
<section class="content">
		...
		<div class="box">
                ...
                <a class="btn bg-olive btn-flat margin" href="<?php print HTTP_ENTRY?>/priv/ask/add">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td>
  						...
  						<a class="btn bg-navy" href="<?php print HTTP_ENTRY?>/priv/ask/viewappend?sid=<?php print $item["aid"]?>"> 查看</a>
  						<a class="btn btn-default" href="<?php print HTTP_ENTRY?>/priv/ask/edit?sid=<?php print $item["aid"]?>"> 编辑</a>
                        <a class="btn btn-danger" href="<?php print HTTP_ENTRY?>/priv/ask/rm?sid=<?php print $item["aid"]?>">删除</a>
                        <a class="btn bg-olive" href="<?php print HTTP_ENTRY?>/priv/ask/append?r=d&askid=<?php print $item["aid"]?>">回答</a>
                        <a class="btn bg-purple" href="<?php print HTTP_ENTRY?>/priv/ask/append?r=u&askid=<?php print $item["aid"]?>">追问</a>
                        <a class="btn bg-maroon" href="<?php print HTTP_ENTRY?>/priv/ask/present?askid=<?php print $item["aid"]?>">送花</a>
