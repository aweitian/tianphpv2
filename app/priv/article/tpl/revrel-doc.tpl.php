		...
		<div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">文章筛选</h3>
                   ...
                   <form action="<?php print HTTP_ENTRY?>/priv/article/revreldoc" class="form-horizontal">
                ...
                <div class="box-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <a class="btn btn-danger" href="<?php print HTTP_ENTRY?>/priv/article/rmreldoc?aid=<?php print $item["aid"]?>&dod=<?php print $item["dod"]?>">删除</a>
