		...
		<div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">文章筛选</h3>
                   ...
                   <form action="<?php print HTTP_ENTRY?>/priv/article/revreldis" class="form-horizontal">
                ...
                <div class="box-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <a class="btn btn-danger" href="<?php print HTTP_ENTRY?>/priv/article/rmreldis?aid=<?php print $item["aid"]?>&did=<?php print $item["mid"]?>">删除</a>
                ...
                <div class="box-footer clearfix">
                  ...
                  <div class="box-tools">
                  	...
                  	<div class="no-margin pull-left" style="width:30%">
                  			...
                  			<form onsubmit="return chk(this)" action="<?php print HTTP_ENTRY?>/priv/article/con_reldis" method="post" class="form-horizontal">
		                  	<div class="form-group">
		                      ...
		                      <input id="article_dds" value="" name="dd" type="hidden">
