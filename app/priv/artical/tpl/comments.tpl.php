...
<section class="content">
		...
		<div class="box">
                ...
                <div class="box-body">
                	<a class="btn bg-olive btn-flat margin" href="<?php print HTTP_ENTRY?>/priv/artical/addcomment?aid=<?php print $_REQUEST["sid"]?>">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-default" href="<?php print HTTP_ENTRY?>/priv/artical/editcomment?sid=<?php print $item["sid"]?>"> 编辑</a>
                        <a class="btn btn-danger" href="<?php print HTTP_ENTRY?>/priv/artical/rmcomment?sid=<?php print $item["sid"]?>">删除</a>
                        <a class="btn btn-default" href="<?php print HTTP_ENTRY?>/priv/artical/vercomment?sid=<?php print $item["sid"]?>"><?php if( $item["vertify"] == "1" ):?><i class="glyphicon glyphicon-remove"></i> 取消<?php else:?><i class="glyphicon glyphicon-ok"></i> 通过<?php endif;?>验证</a>
