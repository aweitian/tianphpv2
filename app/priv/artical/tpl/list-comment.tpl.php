		...
		<div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">文章列表</h3>
                   ...
                   <div class="box-tools">
                   <form action="<?php print HTTP_ENTRY?>/priv/artical/comment">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td>
                      	...
                      	<?php if($item["cnt"] > 0):?>
                        <a class="btn btn-default" href="<?php print HTTP_ENTRY?>/priv/artical/commentlist?sid=<?php print $item["sid"]?>"><i class="glyphicon glyphicon-eye-open"></i> 查看甩有评论</a>
                        <?php else:?>
