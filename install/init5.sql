...
--
-- Host: localhost
-- Generation Time: Apr 19, 2016 at 09:59 PM
...
CREATE TABLE IF NOT EXISTS `data_unit` (
  ...
  `un_code` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`un_id`),
...
CREATE TABLE IF NOT EXISTS `publ_data` (
  ...
  `clks` float NOT NULL COMMENT '点击',
  `datetime` datetime NOT NULL,
  PRIMARY KEY (`pu_id`),
  UNIQUE KEY `uniq` (`id_id`,`datetime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
