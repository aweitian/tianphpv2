  ...
  <div class="wid1000">
    <div class="logintable fz13">
      ...
      <form action="<?php print AppUrl::userLogin()?>" method="post">
        <input  class="logininp gray border2" placeholder='用户名/邮箱/手机号'/>
        <div class="blank25"></div>
        <input  class="logininp gray  border2" placeholder="密码" />
        <div class="blank25"><?php print $info?></div>
        <div class="loginmdlbox clearfix"> <span class="fl">
          <input class="loginmdl fl" type="checkbox" />
          <label> 十天免登录</label>
          </span><span class="fr">忘记密码？</span></div>
        ...
        <div class="loginbtnbox clearfix">
          ...
          <span class="fr loginnozc">没有账号？<a href="<?php print AppUrl::userRegister()?>" class="blue">立即注册</a></span></div>
      </form>
      <div class="blank15"></div>
      <div class="otherlogin clearfix"><span class="fl">你可以使用第三方账号直接登录</span>
      	<span class="fl">
      	<!-- 
