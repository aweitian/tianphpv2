...
<div class="blank20"></div>
  <div id="focusindex">
    <ul class="index_banner_box clearfix">
      <li><a<?php print App::useTarget()?> href=""><img src="<?php print AppUrl::getMediaPath()?>/images/sybanner1.jpg" width="998" height="238" /></a></li>
      <li><a<?php print App::useTarget()?> href=""><img src="<?php print AppUrl::getMediaPath()?>/images/sybanner1.jpg" width="998" height="238" /></a></li>
      <li><a<?php print App::useTarget()?> href=""><img src="<?php print AppUrl::getMediaPath()?>/images/sybanner1.jpg" width="998" height="238" /></a></li>
    </ul>
  </div>
          ...
          <div class="fromzxzjbox1 clearfix">
            ...
            <div class="fromzxzjbox1r fr" id="topzj">
              <dl>
                ...
                <dd class="fl fz12">
                  <p><a<?php print App::useTarget()?> class="blue">陈希球1</a> 副主任医师 </p>
                  <p>男科手术</p>
                  <p class="gray">今天</p>
                </dd>
              </dl>
              <dl>
                <dt class="fl"><img src="<?php print AppUrl::getMediaPath()?>/images/syaskzj.jpg" width="60" height="60" /></dt>
                <dd class="fl fz12">
                  <p><a<?php print App::useTarget()?> class="blue">陈希球2</a> 副主任医师 </p>
                  <p>男科手术</p>
                  <p class="gray">今天</p>
                </dd>
              </dl>
              <dl>
                <dt class="fl"><img src="<?php print AppUrl::getMediaPath()?>/images/syaskzj.jpg" width="60" height="60" /></dt>
                <dd class="fl fz12">
                  <p><a<?php print App::useTarget()?> class="blue">陈希球3</a> 副主任医师 </p>
                  <p>男科手术</p>
                  <p class="gray">今天</p>
                </dd>
              </dl>
		...
		//var_dump($m->getDoctors(5));
		  ?>
            ...
            <dl class="clearfix graybg">
              <dt class="fl"><a<?php print App::useTarget()?> href="<?php print AppUrl::docHomeByDocid($doc["id"])?>"><img src="<?php print AppUrl::getMediaPath()?>/doctor/<?php print $doc["avatar"]?>" width="68" height="68" /></a></dt>
              ...
              <dd class="dd2 fl">
                ...
                <p class="blue"><a<?php print App::useTarget()?> href="">查看最新用户分享 >></a></p>
              </dd>
      ...
      <div class="fromjyfx clearfix">
        <div class="fromjyfxl fl">
          ...
          <div class="fromjyfxlc">
            ...
            <dl class="fz13">
              <dt><span class="gray">疾病：</span> <span class="blue"><a<?php print App::useTarget()?> href="<?php print AppUrl::disHomeByDid($app["did"])?>"><?php print $m->getNameByDid($app["did"])?></a></span></dt>
                ...
                <font class="fr"><span class="gray">接诊医生：</span><span class="blue"><a<?php print App::useTarget()?> href="<?php print AppUrl::docHomeByDod($app["dod"])?>"><?php print $m->getNameByDod($app["dod"])?></a></span></font></p></dd>
            </dl>
			<?php endforeach;?>
            <div class="fromjyfxlb fromjyfxbsm fz12"><a<?php print App::useTarget()?> class="blue" href="<?php print AppUrl::appraisePut()?>">我要对医生评价</a></div>
          </div>
        </div>
        <div class="fromjyfxr fr">
          ...
          <div class="fromjyfxrc">
            ...
            <dl class="fz13">
              ...
              <dd><?php print $m->utf8cut($let["content"],0,64)?>...<a<?php print App::useTarget()?> class="black" href="<?php print AppUrl::docLetterByDodLed($let["dod"], $let["sid"])?>">看详情>></a></dd>
            </dl>
			<?php endforeach;?>
            <div class="fromjyfxrb fromjyfxbsm fz12"><a<?php print App::useTarget()?> class="orange" href="">写感谢信给医生</a></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="fr wid300 fz13">
      ...
      <div class="syrbox3 border2">
        ...
        <div class="syrbox3nr fz13">
          <ul>
            <li><a<?php print App::useTarget()?> href="">早日摆脱前列腺增生的困扰 </a></li>
            <li><a<?php print App::useTarget()?> href="">早日摆脱前列腺增生的困扰 </a></li>
            <li><a<?php print App::useTarget()?> href="">早日摆脱前列腺增生的困扰 </a></li>
            <li><a<?php print App::useTarget()?> href="">早日摆脱前列腺增生的困扰 </a></li>
            <li><a<?php print App::useTarget()?> href="">早日摆脱前列腺增生的困扰 </a></li>
      ...
      <div class="blank20"></div>
      <div><a<?php print App::useTarget()?> href=""><img src="<?php print AppUrl::getMediaPath()?>/images/syrth4.jpg" width="300" height="90" /></a></div>
      <div class="blank20"></div>
      <div><img src="<?php print AppUrl::getMediaPath()?>/images/syrth5.jpg" /></div>
      <div><a<?php print App::useTarget()?> href=""><img src="<?php print AppUrl::getMediaPath()?>/images/syrth6.jpg" /></a></div>
      <div class="blank20"></div>
          ...
          <div class="syrbox5nr_1" id="toplw">
            <dl class="clearfix" >
              ...
              <dd class="fl">
                ...
                <p class="ddp2 fr blue"><a<?php print App::useTarget()?> href="">我也要送</a></p>
              </dd>
            </dl>
            <dl class="clearfix" >
              <dt class="fl"><img src="<?php print AppUrl::getMediaPath()?>/images/syrth10.jpg" width="61" height="57" /></dt>
