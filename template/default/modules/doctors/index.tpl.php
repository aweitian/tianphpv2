...
<?php include dirname(dirname(dirname(__FILE__)))."/inc/banner.php"?>
  ...
  <div class="con_tit fz13">当前位置：<a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="/">首页</a> > <a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="<?php print AppUrl::navDoctors()?>">医护团队</a> </div>
                            ...
                            <li>
                              <dl class="clearfix">
                                ...
                                <dd class="fl">
                                  ...
                                  <p class="p3 tc"><a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="<?php print AppUrl::docHomeByDocid($doc["id"])?>">个人网站</a></p>
                                </dd>
                              </dl>
                              <div class="blank20"></div>
                              <div class="zjsc">
       		...
       		<?php endif;?> </div>
                ...
                <div class="fr wid300 fz13">
                    ...
                    <div class="jb_rg">
                      ...
                      <a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="<?php print AppUrl::getSwtUrl() ?>"><input type="button" class="jb_rg2 fl" /></a>  
                    </div>
