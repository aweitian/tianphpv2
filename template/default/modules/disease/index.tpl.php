  ...
  <div class="quesnum clearfix">
    <div class="quesnuml fl border2">
     <!-- <p class="line24 fz13">今日解决<em class="orange">498</em>个问题</p>  -->
      ...
      <p class="tc"><a href="<?php print AppUrl::navput()?>" onclick="openZoosUrl();return false;"><img src="<?php print AppUrl::getMediaPath()?>/images/nowask.jpg" width="260" height="40" /></a></p>
    </div>
