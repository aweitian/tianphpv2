...
<div class="blank20"></div>
  ...
  <div class="sybox clearfix">
    ...
    <div class="fr wid300 fz13">
      ...
      <div class="blank20"></div>
      <div class="syrbox2">
        <p><a href="<?php print AppUrl::getSwtUrl() ?>"><img src="<?php print AppUrl::getMediaPath()?>/images/syrth1.jpg" width="300" height="100" /></a></p>
        <p class="blank10"></p>
        <p><a href="<?php print AppUrl::getSwtUrl() ?>"><img src="<?php print AppUrl::getMediaPath()?>/images/syrth2.jpg" width="300" height="100" /></a></p>
        <p class="blank10"></p>
        <p><a href="<?php print AppUrl::getSwtUrl() ?>"><img src="<?php print AppUrl::getMediaPath()?>/images/syrth3.jpg" width="300" height="100" /></a></p>
      </div>
      <div class="blank20"></div>
