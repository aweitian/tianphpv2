...
<?php include dirname(dirname(dirname(__FILE__)))."/inc/banner.php"?>
  <div class="listpos fz13"><span class="gray">当前位置：</span><a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="/">首页 </a>> <a href="">男科症状</a></div>
  <div class="clearfix">
        ...
        <dl class="selected">
          ...
          <dd class="fz16 dgray">
            ...
            <p>
            	...
            	<a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="<?php print AppUrl::disHomeByDid($did)?>"><?php print $m->getNameByDid($did) ?></a>|
      ...
      <?php $x=1;?>
        ...
        <div class="fromzzrnr">
          <dl>
            ...
            <a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="<?php print AppUrl::articleBySyd($xzz['syd'])?>"><?php print ($xzz['data']) ?></a>
            	<?php endforeach;?>
        ...
        <div class="fromzzrzj">
          <dl class="clearfix">
            ...
            <dd class="ddl fl">
             ...
             <a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="<?php print AppUrl::docHomeByDocid($doc["id"])?>"> <?php print $doc["name"]; ?></a><span class="dgray"><?php print $doc["lv"]; ?></span></p>
              <p class="p2 fz13 gray"><span class="black">擅长：</span><?php print $doc["spec"]; ?></p>
            </dd>
            <dd class="ddr fr tc fz18"><a<?php if(TARGET_BLANK_OPEN):?> target="_blank"<?php endif?> href="<?php print AppUrl::getSwtUrl(); ?>">点击咨询</a></dd>
          </dl>
        </div>
