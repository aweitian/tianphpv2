        ...
        <?php include dirname(__FILE__)."/common/nav.tpl.php";?>
               ...
               <div class="clr">
               	...
               	<div class="wid680 fl">
                    ...
                    <div class="jb_zstab clearfix dgray fz13 color6">
                            <ul class="clr">
                              <li <?php if($model->subid =="0"):?> class="selected" <?php endif?>><a<?php print App::useTarget()?> href="<?php print AppUrl::disKnowledgeSubByDiskey($row["key"],0) ?>">全部文章</a></li>
                                <li <?php if($model->subid =="1"):?> class="selected" <?php endif?>><a<?php print App::useTarget()?> href="<?php print AppUrl::disKnowledgeSubByDiskey($row["key"],1) ?>">病因</a></li>
                         <li <?php if($model->subid =="2"):?> class="selected" <?php endif?>><a<?php print App::useTarget()?> href="<?php print AppUrl::disKnowledgeSubByDiskey($row["key"],2) ?>">症状</a></li>
                          <li <?php if($model->subid =="3"):?> class="selected" <?php endif?>><a<?php print App::useTarget()?> href="<?php print AppUrl::disKnowledgeSubByDiskey($row["key"],3) ?>">检查</a></li>
                           <li <?php if($model->subid =="4"):?> class="selected" <?php endif?>><a<?php print App::useTarget()?> href="<?php print AppUrl::disKnowledgeSubByDiskey($row["key"],4) ?>">治疗</a></li>
                          <li <?php if($model->subid =="5"):?> class="selected" <?php endif?>><a<?php print App::useTarget()?> href="<?php print AppUrl::disKnowledgeSubByDiskey($row["key"],5) ?>">危害</a></li>
                            <li <?php if($model->subid =="6"):?> class="selected" <?php endif?>><a<?php print App::useTarget()?> href="<?php print AppUrl::disKnowledgeSubByDiskey($row["key"],6) ?>">保健</a></li>
                            </ul>
                        </div>
                      ...
                      <div class="padd20 border2">
                            ...
                            <div class="blank20"></div>
                                ...
                                <?php foreach ($model->getEssenceAidByDid($row["sid"],6) as $jh):?>
                                    <li><a<?php print App::useTarget()?> href="<?php print AppUrl::articleByAid($jh["sid"]) ?>"><?php print $jh["title"] ?></a></li>
                             <?php endforeach; ?>
                                </ul>
                            </div>
                           </div> 
         ...
         <li class="kart_li">
                                    <div class="bb_e5 pb5 clearfix"> 
                                        <span class="f20 fl">
                                        <a<?php print App::useTarget()?> href="<?php print AppUrl::articleByAid($list["aid"]) ?>" class="fl kart_title"><h2><?php print $list["title"] ?></h2></a>
                                        <span class="fl kart_label "><?php print ($tag) ?></span></span>
                                      	<p class="fr color9">发布时间：<?php print $list["date"] ?></p>
                                    </div>
                                    <div class="blank15"></div>
                                    <p class="fz13 color9"> 发布医生： <a<?php print App::useTarget()?>  href="<?php print AppUrl::articleByAid($list["aid"]) ?>" class="blue"><?php print $doc["name"] ?> </a></p>
                                    <div class="pt10 clearfix ">
                                      <div class="fl w435 kart_con"> <?php print utility::utf8Substr( $list["desc"], 0, 80)?>...<a<?php print App::useTarget()?> href="<?php print AppUrl::articleByAid($list["aid"]) ?>"  class="gray_a ml5">查看全文<span class="f8">>></span></a> </div>
                                      <!--轮转图 start-->
                                      <div class="fr kart_doc ml25">
                                              <a<?php print App::useTarget()?> href="<?php print AppUrl::articleByAid($list["aid"]) ?>" ><img src="<?php print AppUrl::getMediaPath()?>/doctor/170X170/<?php print $doc["avatar"]?>" width="80" height="80"  class="fl"></a>
                                            <div class="fl pt20">
                                              <p><a<?php print App::useTarget()?> href="<?php print AppUrl::articleByAid($list["aid"]) ?>"  class="g_home1">个人网站</a></p>
                                              <p><a<?php print App::useTarget()?>  href="<?php print AppUrl::getSwtUrl(); ?>" class="g_advise2" rel="nofollow">可咨询</a>
                                              <p> 
                                        </div>
                                    ...
                                    <div class="kart_share mt20 clearfix fz12">
                                      <p class="fl"> 
                                        ...
                                        <a<?php print App::useTarget()?> class="g_comment" rel="nofollow">评论  <?php print($nuber) ?></a> 
                                        ...
                                        <a<?php print App::useTarget()?> href="<?php print AppUrl::getSwtUrl(); ?>" class="gray_a">全部咨询</a> 
                                        </p>
                                      <p class="fr">
