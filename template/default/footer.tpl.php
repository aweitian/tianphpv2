   <div class="footernav fz13">
    <ul class="clearfix tc">
      <a<?php print App::useTarget()?> href="<?php print AppUrl::process() ?>">门诊流程</a> <a<?php print App::useTarget()?> href="<?php print AppUrl::notice() ?>">住院须知</a> <a<?php print App::useTarget()?> href="<?php print AppUrl::getSwtUrl()?>" onClick="openZoosUrl();return false;">预约服务</a> <a<?php print App::useTarget()?> href="<?php print AppUrl::navSubscribe()?>">预约挂号</a> <a<?php print App::useTarget()?> href="<?php print AppUrl::statement() ?>">隐私声明</a> <a<?php print App::useTarget()?> href="<?php print AppUrl::navDoctors() ?>">医护团队</a> <a<?php print App::useTarget()?> href="<?php print AppUrl::navAsk() ?>">疾病问答</a> <a<?php print App::useTarget()?> href="<?php print AppUrl::toll()?>">价格与收费</a> <a<?php print App::useTarget()?> class="nobor" href="<?php print Appurl::environment() ?>">就诊环境</a>
    </ul>
  </div>
