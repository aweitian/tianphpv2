...
<div class="box_d">
    <div class="clr">
        ...
        <div class="fl">
            ...
            <p class="clr"><a href="<?php print AppChannel::getTel()?>" class="btn_b1">预约通话</a><a href="<?php print AppUrl::getSwtUrl()?>" onClick="openZoosUrl();return false;" class="btn_b2">在线咨询</a></p>
        </div>
    </div> 
</div>