				...
				<?php $ans = $model->getAnswerByAskid($allitem["sid"])?>
                                        ...
                                        <li>
                                            ...
                                            <div class="pt10 bbd_c clearfix">
                                                <div class="fl pr15 pt5"><img src="<?php print HTTP_ENTRY?>/static/avatar/<?php print $user["avatar"]?>" width="31" height="31"></div>
                                            ...
                                            <div class="fl pr15 pt5"><a href="<?php print AppUrl::askByAsdDocid($allitem["dod"], $allitem["sid"]) ?>" target="blank"><img src="<?php print HTTP_ENTRY?>/static/doctor/<?php print $doc["avatar"]?>" width="31" height="31"></a></div>
