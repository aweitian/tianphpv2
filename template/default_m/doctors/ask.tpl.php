...
<div class="bg_fff">
	...
	<dl class="mzy30">
    	<div class="blank20"></div>
        <dd class="clr color9"><a href="<?php print AppUrl::askByAsdDocidAsd($m->data["id"], $ask["sid"]);?>"><span class="fl"><?php print $m->utf8cut($ask["title"],0,16)?></span><span class="fr yellow"><img src="<?php print AppUrl::getMediaPath()?>/images/yswd_img3.png" /><?php print($docount) ?></span></a></dd>
