...
document.writeln("#swtys{width:232px;height:148px; position:fixed;left:50%;top:50%;margin-left:-116px;margin-top:-74px;z-index:999999999;border:4px #fad699 solid;background:#fff3e0;border-radius:15px;-moz-border-radius:15px;-webkit-border-radius:15px;-webkit-box-shadow:0 0 10px #d5d5d5;-moz-box-shadow:0 0 10px #d5d5d5;box-shadow:0 0 10px #d5d5d5;}");
document.writeln(".swtclose2{ position:absolute;top:-16px;right:-8px;cursor:pointer;}");
document.writeln(".ysbd{border:1px #fff solid;padding:15px 7px;height:116px;border-radius:15px;-moz-border-radius:15px;-webkit-border-radius:15px;}");
document.writeln(".ysbd dl{position:relative;}");
document.writeln(".ysbd dt{ position:absolute;top:-23px;left:-5px;}");
document.writeln(".ysbd dd{float:right;width:125px;}");
document.writeln(".ysbd h4{background:url(/static/m/swt/swtbg.png) no-repeat;width:114px;height:23px;font:12px/19px Microsoft Yahei;color:#fff;padding-left:9px;}");
document.writeln(".ysbd h4 span{color:#fff100;}");
document.writeln(".ysbd dd p{color:#333;font:13px/24px Microsoft Yahei;padding-left:15px;}");
...
document.writeln("    <dl>");
document.writeln("      <dt><img src=\'/static/m/swt/<?php print swtbgimg($msg)?>\' width=\'112\' height=\'105\' /></dt>");
document.writeln("      <dd>");
...
document.writeln("    </dl>");
document.writeln("        <ul>");
document.writeln("          <li><a href=\'javascript:void(0)\' onclick=\'openZoosUrl();return false;\'><img src=\'/static/m/swt/swtbtn3.png\' width=\'105\' height=\'36\' /></a></li>");
document.writeln("          <li><a href=\'tel:<?php print AppChannel::getTel()?>\'><img src=\'/static/m/swt/swtbtn4.png\' width=\'105\' height=\'36\' /></a></li>");
document.writeln("      </ul>");
...
document.writeln("<style type=\'text/css\'>");
document.writeln("*{margin:0;padding:0;}");
document.writeln("#swtbox{width:232px;height:128px; position:fixed;left:50%;top:50%;margin-left:-116px;margin-top:-64px;z-index:999999999;border:4px #fad699 solid;background:#fff3e0;border-radius:15px;-moz-border-radius:15px;-webkit-border-radius:15px;-webkit-box-shadow:0 0 10px #d5d5d5;-moz-box-shadow:0 0 10px #d5d5d5;box-shadow:0 0 10px #d5d5d5;}");
document.writeln(".swtbd{border:1px #fff solid;height:106px;padding:10px 6px;border-radius:15px;-moz-border-radius:15px;-webkit-border-radius:15px;color:#333;}");
...
document.writeln("      <ul>");
document.writeln("        <li><a href=\'javascript:void(0)\' onclick=\'openZoosUrl();return false;\'><img src=\'/static/m/swt/swtbtn1.png\' width=\'105\' height=\'36\' /></a></li>");
document.writeln("        <li><a href=\'tel:<?php print AppChannel::getTel()?>\'><img src=\'/static/m/swt/swtbtn2.png\' width=\'105\' height=\'36\' /></a></li>");
document.writeln("      </ul>");
document.writeln("  </div>");
document.writeln("</div>");
